                ...
                <div class="mt-8">
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-center gap-4">
                            <img
                                src="{{ asset('thumbnail/images/'.$item->getproductImage($item->product_id))}}"
                                alt=""
                            ...
                            <div>
                                <h3 class="text-sm text-gray-900">
                                    {{$item->getProductTitle($item->product_id)}}
                                </h3>
                                ...
                                >
                                    <div>
                                        ...
                                        <dd class="inline">
                                            {{$item->getproductPrice($item->product_id)}}
                                            <span
                                                class="border p-1 rounded-sm bg-slate-100"
                                                >BDT</span
                                            >
                                        </dd>
                                    </div>
